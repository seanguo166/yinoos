...
E_D("replace into `ecs_admin_log` values('755','1402580261','1','编辑友情链接: 美乐乐','49.89.13.154');");
E_D("replace into `ecs_admin_log` values('756','1402580289','1','编辑友情链接: 美乐乐源码','49.89.13.154');");
E_D("replace into `ecs_admin_log` values('757','1402580344','1','编辑友情链接: 美乐乐淘宝店','49.89.13.154');");
...
E_D("replace into `ecs_admin_log` values('837','1407322404','1','添加文章: 美乐乐发布美乐乐第二版源码通告','49.89.177.55');");
E_D("replace into `ecs_admin_log` values('838','1407322513','1','添加文章: 美乐乐第二版官方唯一购买地址！','49.89.177.55');");
E_D("replace into `ecs_admin_log` values('839','1407322547','1','编辑文章: 美乐乐第二版官方唯一购买地址！','49.89.177.55');");
E_D("replace into `ecs_admin_log` values('840','1407322577','1','编辑文章: 美乐乐第二版官方唯一购买地址！','49.89.177.55');");
...
E_D("replace into `ecs_admin_log` values('854','1409628693','1','添加拍卖活动: 美乐乐美乐乐源码第二版拍卖测试','49.89.58.226');");
E_D("replace into `ecs_admin_log` values('855','1409628713','1','编辑拍卖活动: 美乐乐美乐乐源码第二版拍卖测试','49.89.58.226');");
...
E_D("replace into `ecs_admin_log` values('865','1420464195','1','编辑商店设置: ','192.168.0.103');");
E_D("replace into `ecs_admin_log` values('866','1420464195','1','编辑商店设置: ','192.168.0.103');");
E_D("replace into `ecs_admin_log` values('867','1420464240','1','编辑权限管理: admin','192.168.0.103');");
