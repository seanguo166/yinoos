...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','美乐乐源码','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','美乐乐第二版源码,高端大气行业ECSHOP商城模板,家具建材家居商城源码下载-美乐乐','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','美乐乐网站模板源码第二版由美乐乐出品','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','美乐乐源码第二版,美乐乐网站模板,美乐乐源码下载,商城源码,ECSHOP模板','1');");
...
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','77882543','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','zhao_324','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','77882543@qq.com','1');");
...
E_D("replace into `ecs_shop_config` values('209','2','rewrite','select','0,1,2','','1','1');");
...
E_D("replace into `ecs_shop_config` values('239','2','certificate_id','hidden','','','1080952234','1');");
E_D("replace into `ecs_shop_config` values('240','2','token','hidden','','','fb9fd1c63d073d8f068720b81bb66d821ae249568c6195ae46ea0e944076e1c7','1');");
...
E_D("replace into `ecs_shop_config` values('304','3','thumb_width','text','','','300','1');");
E_D("replace into `ecs_shop_config` values('305','3','thumb_height','text','','','300','1');");
E_D("replace into `ecs_shop_config` values('306','3','image_width','text','','','800','1');");
E_D("replace into `ecs_shop_config` values('307','3','image_height','text','','','800','1');");
...
E_D("replace into `ecs_shop_config` values('317','3','goods_name_length','text','','','18','1');");
E_D("replace into `ecs_shop_config` values('318','3','price_format','select','0,1,2,3,4,5','','0','1');");
E_D("replace into `ecs_shop_config` values('319','3','page_size','text','','','32','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','布艺沙发,多功能床,儿童床,餐桌椅,家用书桌,吸顶灯','0');");
...
E_D("replace into `ecs_shop_config` values('419','4','anonymous_buy','select','1,0','','0','1');");
...
E_D("replace into `ecs_shop_config` values('424','4','cart_confirm','options','1,2,3,4','','1','0');");
...
E_D("replace into `ecs_shop_config` values('603','6','hash_code','hidden','','','93cca7258ca52ad07b36e47f2baa7685','1');");
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','meilele','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1385534808','1');");
