...
E_D("replace into `ecs_weixin_keywords` values('100','图文消息测试','图文消息','2','','','图文消息的测试标题','美乐乐专注于在信息科技领域中向客户提供商业解决方案，是专业的互联网服务解决方案提供商和网络营销服务专家，为用户提供一体化的网络营销整体解决方案。主要提供以网络营销为核心目标的网站建设、网络营销推广、专业化的网站管理和网站优化、网络应用系统定制开发和网络基础业务。我们将计算机技术与商业应用完美结合起来，以使我们的客户可以在快速发展的信息科技领域中获得更有效的竞争力。 ','http://www.7u7u7u.com.cn/','72','1');");
E_D("replace into `ecs_weixin_keywords` values('105','文本消息测试','文本消息','1','美乐乐欢迎您！','','','','','67','1');");
