...
E_D("replace into `ecs_supplier_admin_action` values('7','0','pickup_point','');");
E_D("replace into `ecs_supplier_admin_action` values('201','7','pickup_point_manage','');");
E_D("replace into `ecs_supplier_admin_action` values('202','7','pickup_point_batch','');");
E_D("replace into `ecs_supplier_admin_action` values('87','4','ship_manage','');");
E_D("replace into `ecs_supplier_admin_action` values('203','1','order_comment_priv','');");
