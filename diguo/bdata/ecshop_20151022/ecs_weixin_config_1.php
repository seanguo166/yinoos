...
E_D("replace into `ecs_weixin_config` values('1','68服务号1','xxxxx','xxxx','xxxxxxx','感谢你的关注','helpmsg','恭喜您绑定成功！','0','0','1','1','','0','恭喜你订单提交成功！','您购买的商品（订单号：\$order_sn）已经发货请注意查收！快递号：\$shoping_code','1','请填写你的邮箱和密码，使用+分割。','','测试自动回复');");
