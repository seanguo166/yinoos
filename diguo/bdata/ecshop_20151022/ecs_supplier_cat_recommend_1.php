...
E_D("replace into `ecs_supplier_cat_recommend` values('129','2','8');");
E_D("replace into `ecs_supplier_cat_recommend` values('123','2','8');");
E_D("replace into `ecs_supplier_cat_recommend` values('126','1','8');");
E_D("replace into `ecs_supplier_cat_recommend` values('130','2','8');");
E_D("replace into `ecs_supplier_cat_recommend` values('134','3','8');");
...
E_D("replace into `ecs_supplier_cat_recommend` values('138','3','8');");
