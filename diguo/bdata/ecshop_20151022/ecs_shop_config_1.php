...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','小京东V4.1演示站','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','小京东V4.1演示站','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','小京东V4.1演示站','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','小京东V4.1演示站','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','精诚网络','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','39035000','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','dyyh999','1');");
...
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','2313298','1');");
...
E_D("replace into `ecs_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:7:{s:6:\"expire\";d:24;s:11:\"expire_unit\";s:4:\"hour\";s:11:\"separate_by\";i:0;s:15:\"level_point_all\";s:4:\"100%\";s:15:\"level_money_all\";s:3:\"50%\";s:18:\"level_register_all\";i:2;s:17:\"level_register_up\";i:60;}s:4:\"item\";a:4:{i:0;a:2:{s:11:\"level_point\";s:3:\"60%\";s:11:\"level_money\";s:3:\"60%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"30%\";s:11:\"level_money\";s:3:\"30%\";}i:2;a:2:{s:11:\"level_point\";s:2:\"7%\";s:11:\"level_money\";s:2:\"7%\";}i:3;a:2:{s:11:\"level_point\";s:2:\"3%\";s:11:\"level_money\";s:2:\"3%\";}}s:2:\"on\";i:1;}','1');");
...
E_D("replace into `ecs_shop_config` values('909','8','sms_register','select','1,0','','1','1');");
...
E_D("replace into `ecs_shop_config` values('150','1','erweima_wapurl','text','','','http://0838g.com/goods.php?id={id}','1');");
...
E_D("replace into `ecs_shop_config` values('1025','8','sms_goods_stockout','select','1,0','','1','1');");
