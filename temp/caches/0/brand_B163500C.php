...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> Disney</div>
</div>
<div class="blank"></div>
  <div class="w main">
    <div class="right-extra">
      <div class="box">
        <h3 class="goods_sxtitle"><span>Disney</span></h3>
        <div class="boxCenterList">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff" width="200" align="center" valign="middle"><div style="width:200px; overflow:hidden;"> 
                   
                  <img src="data/brandlogo/1437428837807736154.jpg" /> 
  ...
  <div id="filter">
    <form method="GET" name="listform" action="brand.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=curr><a href="brand.php?id=3&amp;page=2&amp;sort=goods_id&amp;order=ASC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=3&amp;page=2&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=3&amp;page=2&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=3&amp;page=2&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-DESCending"></b></dd>
          <dd class=><a href="brand.php?id=3&amp;page=2&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
    	
        <div class='pagin pagin-m'><span class='text'><font>2</font>/1</span> 
          <a href="brand.php?id=3&amp;page=1&amp;sort=goods_id&amp;order=DESC" class="prev" >&lt;</a> 
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="brand.php?category=0&display=grid&brand=3&price_min=&price_max=&filter=&filter_attr=&page=2&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			 	 </dd>
        </dl>
...
<form name="selectPageForm" action="/brand.php" method="get">
 ...
 <div class="xm-pagenavi">
    <a class="numbers first iconfont" href="brand.php?id=3&amp;page=1&amp;sort=goods_id&amp;order=DESC">&lt;</a>         </div>
</div>
</form>
<script type="Text/Javascript" language="JavaScript">
<!--
