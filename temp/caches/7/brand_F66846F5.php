...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> 必胜客</div>
</div>
<div class="blank"></div>
  <div class="w main">
    <div class="right-extra">
      <div class="box">
        <h3 class="goods_sxtitle"><span>必胜客</span></h3>
        <div class="boxCenterList">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff" width="200" align="center" valign="middle"><div style="width:200px; overflow:hidden;"> 
                   
                  <img src="data/brandlogo/1437431098320240967.jpg" /> 
  ...
  <div id="filter">
    <form method="GET" name="listform" action="brand.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="brand.php?id=38&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=38&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="brand.php?id=38&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-ASCending"></b></dd>
          <dd  class=><a href="brand.php?id=38&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-DESCending"></b></dd>
          <dd class=><a href="brand.php?id=38&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="brand.php?category=0&display=grid&brand=38&price_min=&price_max=&filter=&filter_attr=&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			 	 </dd>
        </dl>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')" title="文本显示"><img src="themes/68ecshopcom_360buy/images/display_mode_text.gif" alt=""></a>
      ...
      <ul class="list_pic">
                ...
                <li class="item" style="margin-left:0px;" id="li_27">
          <div class="goods-content" style="position:relative">
		 
				 
            </span>
            <div class="goods-pic" ><a href="goods.php?id=27" target="_blank"  title="Ferrero/费列罗 意大利进口威化榛果巧克力30粒礼盒装 生日礼物送女友情人节"><img data-original="images/201507/thumb_img/27_thumb_G_1437506372309.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="Ferrero/费列罗 意大利进口威化榛果巧克力30粒礼盒装 生日礼物送女友情人节" class="pic_img_27"></a> </div>
		            <div class="goods-info"> 
              <div class="goods-name"><a href="goods.php?id=27" target="_blank" title="Ferrero/费列罗 意大利进口威化榛果巧克力30粒礼盒装 生日礼物送女友情人节">Ferrero/费列罗 意大利进口威化榛果巧克力30粒礼盒装 生日礼物送女友情人节<em></em></a></div>
              <div class="goods-price"> <em class="sale-price" title="本店价：79.0">79.0</em> <em class="market-price" title="">95.0</em></div>
              <div class="sell-stat">
                <ul>
                  <li><a href="goods.php?id=27" target="_blank" class="status">0</a>
                    <p>商品销量</p>
                  </li>
                  <li><a href="goods.php?id=27#product-detail" target="_blank">0</a>
                    <p>用户评论</p>
                  </li>
              ...
              <div class="store"> 
              	<a id="collect_27" href="javascript:collect(27); re_collect(27)" class="collet-btn"></a> 
              	<a class="compare-btn shop-compare" data-goods="27" data-type="" onclick="Compare.add(27,'Ferrero/费列罗 意大利进口威化榛果巧克力30粒礼盒装 生日礼物送女友情人节','', 'images/201507/thumb_img/27_thumb_G_1437506372309.jpg', '79.0')"></a> </div>
              <div class="add-cart"> <a href="javascript:addToCart(27);"><i class="icon-shopping-cart"></i>加入购物车</a> </div>
            </div>
          </div>
        </li>
