...
<title>LOVO 罗莱家纺出品全棉斜纹床品套件四件套 兔斯基_家纺_家纺家居_小京东V4.1演示站  </title>
...
<div id="tell_me_form" style="display:none;">
  ...
  <div class="tell_me_con">
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="button" value="提交" onclick="tell_me1(137)" class="tell_btn"/>
            ...
            <div id="name">
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(137);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
              <div class="show_price" style="z-index:101"> 
                                <div class="market_prices_t"> <span class="price">市场价</span><font class="market_price">478.7</font> </div>
                  ...
                  <div class="hover" style="display:none;" id="vip2" onmouseover="hidevip1()" onmouseout="showvip1()"> <span class="rmbPrice">会员等级价格<i></i></span> 
                    ...
                    <span class="rmbPrice"> 铜牌会员：379.0</span> 
                     
                    </br>
                    <span class="rmbPrice"> 金牌会员：359.1</span> 
                     
                    </br>
                    <span class="rmbPrice"> 钻石会员：339.1</span> 
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=137#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
                  <p>累计销量<span>0</span></p>
                </li>
                                <li style="border:none">
                  <p>赠送积分<span><font id="ECS_GOODS_AMOUNT_jf">399</font></span></p>
                                </ul>
            </div>
            <ul id="summary">
              <script type="text/javascript">
              ...
              <li id="choose-amount">
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> （库存<font id="shows_number">4661 </font>） </div>
                </div>
              </li>
                          </ul>
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
              ...
              <div id="choose-btns" class="buyNub-buy"> 
                ...
                <a href="javascript:addToCart(137)" name="bi_addToCart" class="u-buy1">立即购买</a> <a href="javascript:addToCart(137)" name="bi_addToCart" class="u-buy2">加入购物车</a> 
                 
                <a href="javascript:collect(137)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
                <div id="phone_tan" style="display:none"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img src="erweima_png.php?id=137" width="100" height="100" /> </div>
                </div>
                </a>  
              </div>
              <script type="text/javascript">
  ...
  <script>
      ...
      function clickRight() {
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="137" data-type="0" onclick="Compare.add(137,'LOVO 罗莱家纺出品全棉斜纹床品套件四件套 兔斯基','0', 'images/201507/thumb_img/137_thumb_G_1437528855059.jpg', '478.7')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
...
<input type="hidden" id="chat_supp_id" value="7" />
    ...
    <dt class="shop_title">卖家：<a href="supplier.php?suppId=7" target="_blank" style="color:#333333"> 金星家纺</a></dt>
    <dd > </dd>
  ...
  <dl id="hotline">
    <dt>好评率&nbsp;&nbsp;&nbsp;&nbsp;</dt>
    <dd><span class="hot_grey"><span class="hot_red" style="width:100%;"></span></span></dd>
  ...
  <ul class="score_detail">
    ...
    <dl id="hotline">
    <dt >客 服 QQ&nbsp;&nbsp;&nbsp;&nbsp;<em><a href="http://wpa.qq.com/msgrd?v=3&uin=800007396&site=qq&menu=yes" target="_blank" alt="点击这里联系我" title="点击这里联系我"><img src="http://wpa.qq.com/pa?p=1:800007396:4" height="16" border="0" alt="QQ" /></a></em></dt>
    <dd > </dd>
    <div class="ghs_clear"></div>
  </dl>
      <dl id="hotline">
    <dt >客服旺旺&nbsp;&nbsp;&nbsp;&nbsp;<em><a href="http://amos1.taobao.com/msg.ww?v=2&uid=ecshop模板中心&s=2" target="_blank"><img src="http://amos1.taobao.com/online.ww?v=2&uid=ecshop模板中心&s=2" width="16" height="16" border="0" alt="淘宝旺旺" /></a></em></dt>
    <dd > </dd>
    <div class="ghs_clear"></div>
  </dl>
   <!--   <dl id="hotline">
    <dt>客服邮件&nbsp;&nbsp;&nbsp;&nbsp;</dt>
    <dd>68ecshop@qq.com</dd>
    <dd class="ghs_clear"></dd>
  </dl>
  -->  <dl id="hotline">
    <dt>客服电话&nbsp;&nbsp;&nbsp;&nbsp;</dt>
  ...
  <div id="enter-shop"> 
    ...
    <a class="btn_flat1 btn_goto_shop" href="supplier.php?suppId=7" target="_blank">
        进入商店
    </a>
    <a class="btn_flat1 btn_shop_add" href="javascript:guanzhu(7);">
        关注本店
    </a>
	</div>
    <div id="attention-shop">
    	<p>扫一扫，手机访问店铺</p>
	<img src="erweima_supplier.php?sid=7" width="120" height="120" />
    </div>
  </div>
<script>
