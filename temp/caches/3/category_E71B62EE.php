...
<title>口水娃_酒水_酒类饮料_小京东V4.1演示站  </title>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=7">酒类饮料</a> <code>&gt;</code> <a href="category.php?id=271">酒水</a> <code>&gt;</code> 口水娃</div>
</div>
<div class="blank"></div>
  <div class="w main">
	...
	function return_url(url,dxid){
	  $.ajax({    
        ...
        <div class="box_attr_ecshop68" id="attr_list_ul">
          <h4 id="xxxccczzz"><font color="#E31939">酒水 - </font> 商品筛选</h4>
                    <dl style="border-bottom:1px dotted #ccc;border-top:none;">
            <dt>已选条件：</dt>
            <dd class="moredd" style="text-align:right;">&nbsp;<a href="category.php?id=271">全部撤销</dd>
            <dd >
              <ul class="selected_attr">
                                <li ><a href="category.php?id=271&amp;price_min=0&amp;price_max=0&amp;filter=0">品牌：<b >口水娃  X</b></a></li>
                              </ul>
            </dd>
          </dl>
	     ...
	     onblur="if (this.value=='') {this.value='可搜索拼音、汉字查找品牌'}" onkeyup="getBrand_By_Name(this.value);">
              ...
              <div id="brand_zimu" style="display:none;"> <span class="span"><a href="javascript:void(0);" onmouseover="getBrand_By_Zimu(this,'')" id="brand_zimu_all">所有品牌</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'H')" >H</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'X')" >X</a></span>  </div>
              <div id="brand_abox_father" >                 <ul id="brand_abox" class="brand_abox_imgul">
                   
                   
                   
                                    <li title="雪花" name="xuehua" rel="X" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_2" value="90">
                    <a href="category.php?id=271&amp;brand=90&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','2', this);"> <img  src="data/brandlogo/1437437271667562577.jpg"> </a></li>
                   
                   
                                    <li title="哈尔滨" name="haerbin" rel="H" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_3" value="91">
                    <a href="category.php?id=271&amp;brand=91&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','3', this);"> <img  src="data/brandlogo/1437437282844642612.jpg"> </a></li>
	      ...
	      <td><a id="button_brand"></a><a class="button_jd" onclick="duoxuan_Submit('brand',0,'','271','47', '0', '0', '0','');" >确定</a><a href="javascript:void(0);" onclick="hiddenDuoXuan('attr_group_dl_brand', 'brand');" class="button_jd" style="margin-left:10px;white-space:nowrap;">取消</a></td>
	     ...
	     init_more('brand_abox', 'brand_more', '72');	    
            ...
            <dd>
              <ul>
                                ...
                                <li><a href="category.php?id=271&amp;brand=47&amp;price_min=50&amp;price_max=80&amp;filter=0">50&nbsp;-&nbsp;80</a></li>
                 
                 
                                <li><a href="category.php?id=271&amp;brand=47&amp;price_min=80&amp;price_max=110&amp;filter=0">80&nbsp;-&nbsp;110</a></li>
                 
                 
                                <li><a href="category.php?id=271&amp;brand=47&amp;price_min=140&amp;price_max=170&amp;filter=0">140&nbsp;-&nbsp;170</a></li>
                 
                 
                                <li><a href="category.php?id=271&amp;brand=47&amp;price_min=170&amp;price_max=200&amp;filter=0">170&nbsp;-&nbsp;200</a></li>
	     ...
	     <input type="text" name="price_max" id="price_max" value="0" class="price_68ecshop" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" autocomplete="off">
                  ...
                  <a class="button_jd" href="javascript:void()" onclick="location.href='category.php?id=271&amp;brand=47&amp;filter=0&price_min='+document.getElementById('price_min').value+'&price_max='+document.getElementById('price_max').value " >确定</a> </li>
              </ul>
            </dd>
          </dl>
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="category.php?category=271&display=grid&brand=47&price_min=0&price_max=0&filter=0&filter_attr=0&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  ><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=0" style="float:left  ;color:red ">全部</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=1"'  ><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=1" style="float:left ">网站自营</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=2"'  ><a href="category.php?id=271&amp;brand=47&amp;price_min=0&amp;price_max=0&amp;filter=2" style="float:left ">入驻商店铺</a>
	  			 	 </dd>
        </dl>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')" title="文本显示"><img src="themes/68ecshopcom_360buy/images/display_mode_text.gif" alt=""></a>
      ...
      <input type="hidden" name="category" value="271" />
...
//-->
  ...
  <div class="mc" id="cate"> 
      ...
      <h3 onclick="tab(0)" ><b></b>酒水</h3>
      <ul style=" display:block;">
                <li><a href="category.php?id=281"  >预调酒</a></li>
                <li><a href="category.php?id=276"  >白酒</a></li>
                <li><a href="category.php?id=277"  >啤酒</a></li>
                <li><a href="category.php?id=278"  >葡萄酒/果酒</a></li>
                <li><a href="category.php?id=279"  >黄酒/米酒</a></li>
                <li><a href="category.php?id=280"  >养生酒</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(1)" ><b></b>冲调饮品</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=286"  >奶茶</a></li>
                <li><a href="category.php?id=287"  >麦片谷物</a></li>
                <li><a href="category.php?id=282"  >蜂蜜</a></li>
                <li><a href="category.php?id=288"  >咖啡</a></li>
                <li><a href="category.php?id=283"  >成人奶粉</a></li>
                <li><a href="category.php?id=297"  >果味冲调</a></li>
                <li><a href="category.php?id=284"  >豆浆/豆奶粉</a></li>
                <li><a href="category.php?id=285"  >茶叶</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(2)" ><b></b>饮料饮品</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=290"  >茶饮料</a></li>
                <li><a href="category.php?id=296"  >植物蛋白饮料</a></li>
                <li><a href="category.php?id=291"  >碳酸饮料</a></li>
                <li><a href="category.php?id=292"  >功能饮料</a></li>
                <li><a href="category.php?id=293"  >纯牛奶</a></li>
                <li><a href="category.php?id=294"  >酸奶</a></li>
                <li><a href="category.php?id=289"  >果蔬汁</a></li>
                <li><a href="category.php?id=295"  >风味奶</a></li>
                
      </ul>
    </div>
        <div class='item  ' >
      <h3 onclick="tab(3)" style="border:none"><b></b>茗茶</h3>
      <ul style=" display:none;">
                <li><a href="category.php?id=302"  >红茶</a></li>
                <li><a href="category.php?id=303"  >花果茶</a></li>
                <li><a href="category.php?id=298"  >铁观音</a></li>
                <li><a href="category.php?id=304"  >养生茶</a></li>
                <li><a href="category.php?id=299"  >普洱</a></li>
                <li><a href="category.php?id=305"  >其他茶</a></li>
                <li><a href="category.php?id=300"  >龙井</a></li>
                <li><a href="category.php?id=301"  >绿茶</a></li>
