...
<title>罗莱_家用电器_小京东V4.1演示站  </title>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=5">家用电器</a> <code>&gt;</code> 罗莱</div>
</div>
<div class="blank"></div>
  <div class="w main">
	...
	function return_url(url,dxid){
	  $.ajax({    
        ...
        <div class="box_attr_ecshop68" id="attr_list_ul">
          <h4 id="xxxccczzz"><font color="#E31939">家用电器 - </font> 商品筛选</h4>
                    <dl style="border-bottom:1px dotted #ccc;border-top:none;">
            <dt>已选条件：</dt>
            <dd class="moredd" style="text-align:right;">&nbsp;<a href="category.php?id=5">全部撤销</dd>
            <dd >
              <ul class="selected_attr">
                                <li ><a href="category.php?id=5&amp;price_min=0&amp;price_max=0&amp;filter=2">品牌：<b >罗莱  X</b></a></li>
                              </ul>
            </dd>
          </dl>
	     ...
	     onblur="if (this.value=='') {this.value='可搜索拼音、汉字查找品牌'}" onkeyup="getBrand_By_Name(this.value);">
              ...
              <div id="brand_zimu" style="display:none;"> <span class="span"><a href="javascript:void(0);" onmouseover="getBrand_By_Zimu(this,'')" id="brand_zimu_all">所有品牌</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'G')" >G</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'H')" >H</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'L')" >L</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'M')" >M</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'S')" >S</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'X')" >X</a></span>  <span><a href="javascript:void(0);"  onmouseover="getBrand_By_Zimu(this,'Y')" >Y</a></span>  </div>
              <div id="brand_abox_father" >                 <ul id="brand_abox" class="brand_abox_imgul">
                   
                   
                   
                                    <li title="LG" name="LG" rel="L" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_2" value="28">
                    <a href="category.php?id=5&amp;brand=28&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','2', this);"> <img  src="data/brandlogo/1437430374768843113.jpg"> </a></li>
                   
                   
                                    <li title="三星" name="sanxing" rel="S" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_3" value="30">
                    <a href="category.php?id=5&amp;brand=30&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','3', this);"> <img  src="data/brandlogo/1437430441802693617.png"> </a></li>
                   
                   
                                    <li title="海尔" name="haier" rel="H" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_4" value="66">
                    <a href="category.php?id=5&amp;brand=66&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','4', this);"> <img  src="data/brandlogo/1437433767280039957.jpg"> </a></li>
                   
                   
                                    <li title="美的" name="meide" rel="M" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_5" value="67">
                    <a href="category.php?id=5&amp;brand=67&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','5', this);"> <img  src="data/brandlogo/1437433779804083933.jpg"> </a></li>
                   
                   
                                    <li title="格力" name="geli" rel="G" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_6" value="68">
                    <a href="category.php?id=5&amp;brand=68&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','6', this);"> <img  src="data/brandlogo/1437433795060834486.jpg"> </a></li>
                   
                   
                                    <li title="西门子" name="ximenzi" rel="X" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_7" value="70">
                    <a href="category.php?id=5&amp;brand=70&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','7', this);"> <img  src="data/brandlogo/1437433823734794032.gif"> </a></li>
                   
                   
                                    <li title="格兰仕" name="gelanshi" rel="G" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_8" value="71">
                    <a href="category.php?id=5&amp;brand=71&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','8', this);"> <img  src="data/brandlogo/1437433840630073088.jpg"> </a></li>
                   
                   
                                    <li title="伊莱克斯" name="yilaikesi" rel="Y" class="bottom">
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_9" value="73">
                    <a href="category.php?id=5&amp;brand=73&amp;price_min=0&amp;price_max=0&amp;filter=2" onclick="return duoxuan_Onclick('brand','9', this);"> <img  src="data/brandlogo/1437434172223731860.jpg"> </a></li>
	      ...
	      <td><a id="button_brand"></a><a class="button_jd" onclick="duoxuan_Submit('brand',0,'','5','78', '0', '0', '0','');" >确定</a><a href="javascript:void(0);" onclick="hiddenDuoXuan('attr_group_dl_brand', 'brand');" class="button_jd" style="margin-left:10px;white-space:nowrap;">取消</a></td>
	     ...
	     init_more('brand_abox', 'brand_more', '72');	    
            ...
            <dd>
              <ul>
                                ...
                                <li><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=1300&amp;filter=2">0&nbsp;-&nbsp;1300</a></li>
                 
                 
                                <li><a href="category.php?id=5&amp;brand=78&amp;price_min=1300&amp;price_max=2600&amp;filter=2">1300&nbsp;-&nbsp;2600</a></li>
                 
                 
                                <li><a href="category.php?id=5&amp;brand=78&amp;price_min=2600&amp;price_max=3900&amp;filter=2">2600&nbsp;-&nbsp;3900</a></li>
                 
                 
                                <li><a href="category.php?id=5&amp;brand=78&amp;price_min=5200&amp;price_max=6500&amp;filter=2">5200&nbsp;-&nbsp;6500</a></li>
	     ...
	     <input type="text" name="price_max" id="price_max" value="0" class="price_68ecshop" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" autocomplete="off">
                  ...
                  <a class="button_jd" href="javascript:void()" onclick="location.href='category.php?id=5&amp;brand=78&amp;filter=2&price_min='+document.getElementById('price_min').value+'&price_max='+document.getElementById('price_max').value " >确定</a> </li>
              </ul>
            </dd>
          </dl>
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="category.php?category=5&display=grid&brand=78&price_min=0&price_max=0&filter=2&filter_attr=0&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=0"'  ><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=0" style="float:left ">全部</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=1"'  ><a href="category.php?id=5&amp;brand=78&amp;price_min=0&amp;price_max=0&amp;filter=1" style="float:left ">网站自营</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id