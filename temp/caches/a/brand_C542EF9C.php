...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> 华为</div>
</div>
<div class="blank"></div>
  <div class="w main">
    <div class="right-extra">
      <div class="box">
        <h3 class="goods_sxtitle"><span>华为</span></h3>
        <div class="boxCenterList">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff" width="200" align="center" valign="middle"><div style="width:200px; overflow:hidden;"> 
                   
                  <img src="data/brandlogo/1437430344637755359.jpg" /> 
  ...
  <div id="filter">
    <form method="GET" name="listform" action="brand.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="brand.php?id=25&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=25&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=25&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=25&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-DESCending"></b></dd>
          <dd class=curr><a href="brand.php?id=25&amp;page=1&amp;sort=click_count&amp;order=ASC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="brand.php?category=0&display=grid&brand=25&price_min=&price_max=&filter=&filter_attr=&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			 	 </dd>
        </dl>
      ...
      <ul class="list_pic">
          ...
          <div class="goods-content" style="position:relative">
            ...
            <div class="goods-pic" ><a href="goods.php?id=147" target="_blank"  title="【套装版】荣耀 6 Plus (PE-TL20) 3GB内存标准版 白色 移动4G手机 双卡双待双通"><img data-original="images/201507/thumb_img/147_thumb_G_1437530142553.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="【套装版】荣耀 6 Plus (PE-TL20) 3GB内存标准版 白色 移动4G手机 双卡双待双通" class="pic_img_147"></a> </div>
              ...
              <div class="goods-price"> <em class="sale-price" title="本店价：2199.0">2199.0</em> <em class="market-price" title="">2300.0</em></div>
              <div class="sell-stat">
                <ul>
                  <li><a href="goods.php?id=147" target="_blank" class="status">0</a>
                    <p>商品销量</p>
                  </li>
                  <li><a href="goods.php?id=147#product-detail" target="_blank">0</a>
                    <p>用户评论</p>
                  </li>
                  <li><em member_id="46"><a class="chat chat_offline" href="javascript:;">4</a>&nbsp;</em>
                    <p>关注人气</p>
                  </li>
                </ul>
              </div>
              <div class="store"> 
              	...
              	<a class="compare-btn shop-compare" data-goods="147" data-type="" onclick="Compare.add(147,'【套装版】荣耀 6 Plus (PE-TL20) 3GB内存标准版 白色 移动4G手机 双卡双待双通','', 'images/201507/thumb_img/147_thumb_G_1437530142553.jpg', '2199.0')"></a> </div>
