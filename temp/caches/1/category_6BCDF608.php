...
<title>洗发_洗发护发_个护化妆_小京东V4.1演示站  </title>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=3">个护化妆</a> <code>&gt;</code> <a href="category.php?id=110">洗发护发</a> <code>&gt;</code> <a href="category.php?id=119">洗发</a></div>
</div>
<div class="blank"></div>
  <div class="w main">
	...
	function return_url(url,dxid){
	  $.ajax({    
        ...
        <div class="box_attr_ecshop68" id="attr_list_ul">
          <h4 id="xxxccczzz"><font color="#E31939">洗发 - </font> 商品筛选</h4>
	     ...
	     onblur="if (this.value=='') {this.value='可搜索拼音、汉字查找品牌'}" onkeyup="getBrand_By_Name(this.value);">
              ...
              <div id="brand_abox_father" >                 <ul id="brand_abox" class="brand_abox_imgul">
                    ...
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_2" value="1">
                    <a href="category.php?id=119&amp;brand=1&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','2', this);"> <img  src="data/brandlogo/1437428736611050860.jpg"> </a></li>
                   
                   
                                    <li title="Dior" name="Dior" rel="D" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_3" value="6">
                    <a href="category.php?id=119&amp;brand=6&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','3', this);"> <img  src="data/brandlogo/1437428980225446797.jpg"> </a></li>
                   
                   
                                    <li title="碧欧泉" name="biouquan" rel="B" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_4" value="19">
                    <a href="category.php?id=119&amp;brand=19&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','4', this);"> <img  src="data/brandlogo/1437430106997787476.jpg"> </a></li>
	      ...
	      <td><a id="button_brand"></a><a class="button_jd" onclick="duoxuan_Submit('brand',0,'','119','0', '0', '0', '0','');" >确定</a><a href="javascript:void(0);" onclick="hiddenDuoXuan('attr_group_dl_brand', 'brand');" class="button_jd" style="margin-left:10px;white-space:nowrap;">取消</a></td>
	     ...
	     init_more('brand_abox', 'brand_more', '72');	    
            ...
            <dd>
              <ul>
                                ...
                                <li><a href="category.php?id=119&amp;price_min=21&amp;price_max=35&amp;filter=0">21&nbsp;-&nbsp;35</a></li>
                 
                 
                                <li><a href="category.php?id=119&amp;price_min=35&amp;price_max=49&amp;filter=0">35&nbsp;-&nbsp;49</a></li>
                 
                 
                                <li><a href="category.php?id=119&amp;price_min=77&amp;price_max=91&amp;filter=0">77&nbsp;-&nbsp;91</a></li>
	     ...
	     <input type="text" name="price_max" id="price_max" value="0" class="price_68ecshop" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" autocomplete="off">
                  ...
                  <a class="button_jd" href="javascript:void()" onclick="location.href='category.php?id=119&amp;filter=0&price_min='+document.getElementById('price_min').value+'&price_max='+document.getElementById('price_max').value " >确定</a> </li>
              </ul>
            </dd>
          </dl>
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
        ...
        <div class='total'><span>共<strong>4</strong>个商品</span></div>
        <div style="height:0px; line-height:0px; clear:both;"></div>
      </div>
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="category.php?category=119&display=grid&brand=0&price_min=0&price_max=0&filter=0&filter_attr=0&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  ><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=0" style="float:left  ;color:red ">全部</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=1"'  ><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=1" style="float:left ">网站自营</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=2"'  ><a href="category.php?id=119&amp;price_min=0&amp;price_max=0&amp;filter=2" style="float:left ">入驻商店铺</a>
	  			 	 </dd>
        </dl>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')" title="文本显示"><img src="themes/68ecshopcom_360buy/images/display_mode_text.gif" alt=""></a>
      ...
      <ul class="list_pic">
                ...
                <li class="item" style="margin-left:0px;" id="li_153">
          <div class="goods-content" style="position:relative">
		 
				<span class="little_pic">新品</span> 
            </span>
            <div class="goods-pic" ><a href="goods.php?id=153" target="_blank"  title="沙宣垂坠质感润发乳750ml"><img data-original="images/201507/thumb_img/153_thumb_G_1437530435593.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="沙宣垂坠质感润发乳750ml" class="pic_img_153"></a> </div>
		            <div class="goods-info"> 
              <div class="goods-name"><a href="goods.php?id=153" target="_blank" title="沙宣垂坠质感润发乳750ml">沙宣垂坠质感润发乳750ml<em></em></a></div>
              <div class="goods-price"> <em class="sale-price" title="本店价：90.0">90.0</em> <em class="market-price" title="">108.0</em></div>
              <div class="sell-stat">
                <ul>
                  <li><a href="goods.php?id=153" target="_blank" class="status">0</a>
                    <p>商品销量</p>
                  </li>
                  <li><a href="goods.php?id=153#product-detail" target="_blank">0</a>
                    <p>用户评论</p>
                  </li>
              ...
              <div class="store"> 
              	<a id="collect_153" href="javascript:collect(153); re_collect(153)" class="collet-btn"></a> 
              	<a class="compare-btn shop-compare" data-goods="153" data-type="0" onclick="Compare.add(153,'沙宣垂坠质感润发乳750ml','0', 'images/201507/thumb_img/153_thumb_G_1437530435593.jpg', '90.0')"></a> </div>
              <div class="add-cart"> <a href="javascript:addToCart(153);"><i class="icon-shopping-cart"></i>加入购物车</a> </div>
            </div>
          </div>
        </li>
          ...
          <div class="goods-content" style="position:relative">
            ...
            <div class="goods-pic" ><a href="goods.php?id=145" target="_blank"  title="海飞丝去屑洗发露(海洋活力型)750ml"><img data-original="images/201507/thumb_img/145_thumb_G_1437529875442.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="海飞丝去屑洗发露(海洋活力型)750ml" class="pic_img_145"></a> </div>
		            <div class="goods-info"> 
              <div class="goods-name"><a href="goods.php?id=145" target="_blank" title="海飞丝去屑洗发露(海洋活力型)750ml">海飞丝去屑洗发露(海洋活力型)750ml<em></em></a></div>
              <div class="goods-price"> <em class="sale-price" title="本店价：81.0">81.0</em> <em class="market-price" title="">97.0</em></div>
              <div class="sell-stat">
                <ul>
                  <li><a href="goods.php?id=145" target="_blank" class="status">0</a>
                    <p>商品销量</p>
                  </li>
                  <li><a href="goods.php?id=145#product-detail" target="_blank">0</a>
                    <p>用户评论</p>
                  </li>
                  <li><em member_id="46"><a class="chat chat_offline" href="javascript:;">0</a>&nbsp;</em>
                    <p>关注人气</p>
              ...
              <div class="store"> 
              	<a id="collect_145" href="javascript:collect(145); re_collect(145)" class="collet-btn"></a> 
              	<a class="compare-btn shop-compare" data-goods="145" data-type="0" onclick="Compare.add(145,'海飞丝去屑洗发露(海洋活力型)750ml','0', 'images/201507/thumb_img/145_thumb_G_1437529875442.jpg', '81.0')"></a> </div>
              <div class="add-cart"> <a href="javascript:addToCart(145);"><i class="icon-shopping-cart"></i>加入购物车</a> </div>
            </div>
          </div>
        </li>
         
         
                <li class="item"  id="li_158">
          <div class="goods-content" style="position:relative">
		 
				<span class="little_pic">新品</span> 
            </span>
            <div class="goods-pic" ><a href="goods.php?id=158" target="_blank"  title="L’OREAL/欧莱雅 精油润养洗发露700ml"><img data-original="images/201507/thumb_img/158_thumb_G_1437530565110.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="L’OREAL/欧莱雅 精油润养洗发露700ml" class="pic_img_158"></a> </div>
		            <div class="goods-info"> 
              <div class="goods-name"><a href="goods.php?id=158" target="_blank" title="L’OREAL/欧莱雅 精油润养洗发露700ml">L’OREAL/欧莱雅 精油润养洗发露700ml<em></em></a></div>
              <div class="goods-price"> <em class="sale-price" title="本店价：40.0">40.0</em> <em class="market-price" title="">48.0</em></div>
              <div class="sell-stat">
                <ul>
                  <li><a href="goods.php?id=158" target="_blank" class="status">0</a>
                    <p>商品销量</p>
                  </li>
                  <li><a href="goods.php?id=158#product-detail" target="_blank">0</a>
                    <p>用户评论</p>
                  </li>
                  <li><em member_id="46"><a class="chat chat_offline" href="javascript:;">0</a>&nbsp;</em>
                    <p>关注人气</p>
              ...
              <div class="store"> 
              	<a id="collect_158" href="javascript:collect(158); re_collect(158)" class="collet-btn"></a> 
              	<a class="compare-btn shop-compare" data-goods="158" data-type="0" onclick="Compare.add(158,'L’OREAL/欧莱雅 精油润养洗发露700ml','0', 'images/201507/thumb_img/158_thumb_G_1437530565110.jpg', '40.0')"></a> </div>
              <div class="add-cart"> <a href="javascript:addToCart(158);"><i class="icon-shopping-cart"></i>加入购物车</a> </div>
            </div>
          </div>
        </li>
          ...
          <div class="goods-content" style="position:relative">
            ...
            <div class="goods-pic" ><a href="goods.php?id=166" target="_blank"  title="欧莱雅角质顺滑去屑洗发露200ml"><img data-original="images/201507/thumb_img/166_thumb_G_1437531158758.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="欧莱雅角质顺滑去屑洗发露200ml" class="pic_img_166"></a> </div>
		            <div class="goods-info"> 
              <div class="goods-name"><a href="goods.php?id=166" target="_blank" title="欧莱雅角质顺滑去屑洗发露200ml">欧莱雅角质顺滑去屑洗发露200ml<em></em></a></div>
              <div class="goods-price"> <em class="sale-price" title="本店价：22.0">22.0</em> <em class="market-price" title="">26.0</em></div>
              <div class="sell-stat">
                <ul>
                  <li><a href="goods.php?id=166" target="_blank" class="status">0</a>
                    <p>商品销量</p>
                  </li>
                  <li><a href="goods.php?id=166#product-detail" target="_blank">0</a>
                    <p>用户评论</p>
                  </li>
                  <li><em member_id="46"><a class="chat chat_offline" href="javascript:;">0</a>&nbsp;</em>
                    <p>关注人气</p>
              ...
              <div class="store"> 
              	<a id="collect_166" href="javascript:collect(166); re_collect(166)" class="collet-btn"></a> 
              	<a class="compare-btn shop-compare" data-goods="166" data-type="0" onclick="Compare.add(166,'欧莱雅角质顺滑去屑洗发露200ml','0', 'images/201507/thumb_img/166_thumb_G_1437531158758.jpg', '22.0')"></a> </div>
              <div class="add-cart"> <a href="javascript:addToCart(166);"><i class="icon-shopping-cart"></i>加入购物车</a> </div>
            </div>
          </div>
        </li>
...
//-->
  ...
  <div class="mc" id="cate"> 
      ...
      <ul style=" display:none;">
                ...
                <li><a href="category.php?id=136"  >香水</a></li>
      ...
      <ul style=" display:block;">
                ...
                <li><a href="category.php?id=119"  class="curr">洗发</a></li>
...
{ 
        ...
        <div class="mc">
          <div class="clock" id="clock537">
            <ul>
                                          <li class="fore1" >
                <div class="p-img"><a target="_blank" title="L’OREAL/欧莱雅 精油润养洗发露700ml" href="goods.php?id=158"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/158_thumb_G_1437530565110.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="L’OREAL/欧莱雅 精油润养洗发露700ml" href="goods.php?id=158">L’OREAL/欧莱雅 精油润养洗发露700ml</a></div>
                <div class="p-price"><strong>40.0</strong><del>48.0</del></div>
              </li>
                            <div class="blank5"></div>
               
                                                        <li class="fore2" >
                <div class="p-img"><a target="_blank" title="欧莱雅角质顺滑去屑洗发露200ml" href="goods.php?id=166"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/166_thumb_G_1437531158758.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="欧莱雅角质顺滑去屑洗发露200ml" href="goods.php?id=166">欧莱雅角质顺滑去屑洗发露200ml</a></div>
                <div class="p-price"><strong>22.0</strong><del>26.0</del></div>
              </li>
                            <div class="blank5"></div>
               
                                                        <li class="fore3" >
                <div class="p-img"><a target="_blank" title="海飞丝去屑洗发露(海洋活力型)750ml" href="goods.php?id=145"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/145_thumb_G_1437529875442.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="海飞丝去屑洗发露(海洋活力型)750ml" href="goods.php?id=145">海飞丝去屑洗发露(海洋活力型)750ml</a></div>
                <div class="p-price"><strong>81.0</strong><del>97.0</del></div>
              </li>
                            <div class="blank5"></div>
               
                                                        <li class="fore4" >
                <div class="p-img"><a target="_blank" title="沙宣垂坠质感润发乳750ml" href="goods.php?id=153"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/153_thumb_G_1437530435593.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="沙宣垂坠质感润发乳750ml" href="goods.php?id=153">沙宣垂坠质感润发乳750ml</a></div>
                <div class="p-price"><strong>90.0</strong><del>108.0</del></div>
              </li>
