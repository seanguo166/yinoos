  ...
  <div id="filter">
    <form method="GET" name="listform" action="<?php echo $this->_var['actname']; ?>">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=<?php if ($this->_var['pager']['sort'] == 'goods_id'): ?>curr<?php endif; ?>><a href="<?php echo $this->_var['shangjian']; ?>">上架</a><b class="icon-order-<?php if ($this->_var['pager']['sort'] == 'goods_id'): ?><?php echo $this->_var['pager']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b></dd>
          <dd  class=<?php if ($this->_var['pager']['sort'] == 'salenum'): ?>curr<?php endif; ?>><a href="<?php echo $this->_var['xiaoliang']; ?>">销量</a><b class="icon-order-<?php if ($this->_var['pager']['sort'] == 'salenum'): ?><?php echo $this->_var['pager']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b></dd>
          <dd  class=<?php if ($this->_var['pager']['sort'] == 'shop_price'): ?>curr<?php endif; ?>><a href="<?php echo $this->_var['jiage']; ?>">价格</a><b class="icon-order-<?php if ($this->_var['pager']['sort'] == 'shop_price'): ?><?php echo $this->_var['pager']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b></dd>
          <dd  class=<?php if ($this->_var['pager']['sort'] == 'last_update'): ?>curr<?php endif; ?>><a href="<?php echo $this->_var['gengxin']; ?>">更新</a><b class="icon-order-<?php if ($this->_var['pager']['sort'] == 'last_update'): ?><?php echo $this->_var['pager']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b></dd>
          <dd class=<?php if ($this->_var['pager']['sort'] == 'click_count'): ?>curr<?php endif; ?>><a href="<?php echo $this->_var['renqi']; ?>" rel='nofollow'>人气</a><b class="icon-order-<?php if ($this->_var['pager']['sort'] == 'click_count'): ?><?php echo $this->_var['pager']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b></dd>
	</dl>
