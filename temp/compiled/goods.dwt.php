...
?> 
                ...
                <div class="dd"> <a class="activity-68 activity_4" href="snatch.php" title="<?php echo $this->_var['lang']['snatch']; ?>" style="font-weight:100; color:#fff; text-decoration:none;"><?php echo $this->_var['lang']['snatch']; ?></a> <a href="snatch.php" title="<?php echo $this->_var['lang']['snatch']; ?>" class="activity_con"><?php echo $this->_var['item']['act_name']; ?></a> </div>
                <?php elseif ($this->_var['item']['type'] == "group_buy"): ?>
                <div class="dd"> <a class="activity-68 activity_4" href="group_buy.php" title="<?php echo $this->_var['lang']['group_buy']; ?>" style="font-weight:100; color:#fff; text-decoration:none;"><?php echo $this->_var['lang']['group_buy']; ?></a> <a href="group_buy.php" title="<?php echo $this->_var['lang']['group_buy']; ?>" class="activity_con"><?php echo $this->_var['item']['act_name']; ?></a> </div>
                <?php elseif ($this->_var['item']['type'] == "auction"): ?>
                <div class="dd"> <a class="activity-68 activity_4" href="auction.php" title="<?php echo $this->_var['lang']['auction']; ?>" style="font-weight:100; color:#fff; text-decoration:none;"><?php echo $this->_var['lang']['auction']; ?></a> <a href="auction.php" title="<?php echo $this->_var['lang']['auction']; ?>" class="activity_con"><?php echo $this->_var['item']['act_name']; ?></a> </div>
            ...
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
              ...
              <div id="choose-btns" class="buyNub-buy"> 
                ...
                <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" name="bi_addToCart" class="u-buy1">立即购买</a> <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" name="bi_addToCart" class="u-buy2">加入购物车</a> 
                <?php else: ?> 
                <a onclick="tell_me(<?php echo $this->_var['goods']['goods_id']; ?>)" class="tell_me"/><i></i>到货通知</a>
                <?php endif; ?> 
