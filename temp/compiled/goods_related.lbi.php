...
?> 
      <li <?php if ($this->_foreach['releated_goods_data']['iteration'] == 1): ?>style="border-top:none;"<?php endif; ?>>
      <div class="p-img"><a href="<?php echo $this->_var['releated_goods_data']['url']; ?>"><img width="100" height="100" alt="<?php echo $this->_var['releated_goods_data']['name']; ?>"  src="<?php echo $this->_var['releated_goods_data']['goods_thumb']; ?>"/></a></div>
      <div class="rate"><a href="<?php echo $this->_var['releated_goods_data']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['releated_goods_data']['goods_name']); ?>"><?php echo $this->_var['releated_goods_data']['short_name']; ?></a></div>
