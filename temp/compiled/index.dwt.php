...
<?php $this->assign('articles',$this->_var['articles_19']); ?><?php $this->assign('articles_cat',$this->_var['articles_cat_19']); ?><?php echo $this->fetch('library/cat_articles.lbi'); ?>
  ...
  <script type="text/javascript">
	...
	<?php $_from = $this->_var['row']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_72872400_1445444787');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_72872400_1445444787']):
?>
	<?php if ($this->_var['row_0_72872400_1445444787']['send_start_date'] < $this->_var['time'] && $this->_var['row_0_72872400_1445444787']['send_end_date'] > $this->_var['time']): ?>
    <div class="bonusimg_box">
		<a href="javascript:;" onclick="fun(<?php echo $this->_var['row_0_72872400_1445444787']['type_id']; ?>)" style="background:url(data/bonusimg/<?php echo $this->_var['row_0_72872400_1445444787']['bonus_code']; ?>) no-repeat center top;"></a>
	</div>
	<?php endif; ?> 
...
?> 
          ...
          <li>
            <dl>
              <dt class="goods-name"><a href="pro_goods.php?id=<?php echo $this->_var['goods']['id']; ?>"  title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['short_style_name']; ?></a></dt>
              <dd class="goods-thumb"> <a href="pro_goods.php?id=<?php echo $this->_var['goods']['id']; ?>"  title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"> <img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"> </a> </dd>
              ...
              <dd class="time-remain" count_down="<?php echo $this->_var['goods']['lefttime']; ?>"><i></i><span id="leftTime<?php echo $this->_var['key']; ?>"><em time_id="d"></em>天<em time_id="h"></em>小时 <em time_id="m"></em>分<em time_id="s"></em>秒 </span></dd>
