...
$modules['18_virtual']['50_virtual_card_list_sup']   = 'virtual_goods.php?act=list&extension_code=virtual_good&supp=1'; //虚拟商品列表
$modules['18_virtual']['50_virtual_card_list']   = 'virtual_goods.php?act=list&extension_code=virtual_good'; //虚拟商品列表
$modules['18_virtual']['51_virtual_card_add']    = 'virtual_goods.php?act=add&extension_code=virtual_good';  //添加虚拟商品
$modules['18_virtual']['virtual_goods_validate']   = 'virtual_goods.php?act=verification';
/*虚拟卷订单列表_添加_START_www.68ecshop.com*/
...
$modules['18_virtual']['01_virtual_goods_classify'] = 'category.php?act=virtual_list';  //虚拟商品分类管理
$modules['18_virtual']['01_virtual_goods_district'] = 'virtual_goods.php?act=district';  //虚拟商品商圈管理
/* 虚拟团购 代码增加_end   By  www.68ecshop.com */


$modules['20_chat']['chat_server']       = 'chat_settings.php';         // 聊天服务设置
