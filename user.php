...
function action_oath ()
{
	...
	if($c)
	{
		...
		$url = 'http://www.dasmego.com/user.php?act=oath_login&type=' . $type . '&callblock=' . urlencode($back_act) . '&open=' . $open;
		$url = 'http://www.360jinhuo.com/user.php?act=oath_login&type=' . $type . '&callblock=' . urlencode($back_act) . '&open=' . $open;
